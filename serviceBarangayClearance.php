...
// If transaction provided, try to fetch chosen payment method for display (like reference)
$chosenPayment = null;
if ($transactionId) {
    $stmt = $conn->prepare("
        ...
        <form id="barangayClearanceForm" action="functions/serviceBarangayClearance_submit.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="payment-container p-4 border rounded shadow-sm bg-green">
                ...
                <div class="col-md-8 text-center">
                    ...
                    <input type="hidden" id="paymentMethod" name="payment_method" value="Brgy Payment Device">
                </div>
