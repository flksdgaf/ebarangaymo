...
<body>
  ...
  <p>
    ...
    ng Punong Barangay noong <strong>ika-<?= $day ?> ng <?= $monthFil ?>, <?= $year ?></strong> upang ireklamo si
  ...
  <p class="no-indent">
    Nilagdaan sa Barangay Magang ngayong <strong>ika-<?= $day ?> ng <?= $monthFil ?>, <?= $year ?></strong>
