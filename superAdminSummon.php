    ...
    <div class="d-flex align-items-center mb-3">
      <div class="dropdown">
        ...
        <div class="dropdown-menu p-3" aria-labelledby="filterDropdown" style="min-width:260px; --bs-body-font-size:.75rem; font-size:.75rem;">
          <form method="get" action="?page=superAdminComplaints" id="summonfilterForm" class="mb-0">
            <!-- preserve search -->
            ...
            <div class="d-flex">
              <a href="?page=superAdminComplaints&summon_page=1" class="btn btn-sm btn-outline-secondary me-2">Reset</a>
      ...
      <form method="get" action="?page=superAdminComplaints" id="searchFormSummon" class="d-flex ms-auto me-2">
        <input type="hidden" name="page" value="superAdminComplaints">
        <input type="hidden" name="summon_date_from" value="<?=htmlspecialchars($date_from)?>">
        <input type="hidden" name="summon_date_to" value="<?=htmlspecialchars($date_to)?>">
            ...
            ?>
              <tr data-id="<?= $tid ?>">
                ...
                <td class="text-center">
                  <!-- Edit -->
                  <a href="edit_complaint.php?transaction_id=<?= $tid ?>" class="btn btn-sm btn-success" title="Edit <?= $tid ?>">
                  ...
                  <!-- Delete -->
                  <button class="btn btn-sm btn-danger" title="Delete <?= $tid ?>" onclick="if (confirm('Delete complaint <?= $tid ?>? This cannot be undone.')) {window.location.href='delete_blotter.php?transaction_id=<?= $tid ?>';}">
                    <span class="material-symbols-outlined" style="font-size: 12px;">
                      delete
                    </span>
                  </button>
