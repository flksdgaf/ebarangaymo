    ...
    <head>
      ...
      <style>
        ...
        .id-back {
          ...
          vertical-align: top;
          width: 3.375in; /* Standard ID width */
          height: 1.85in; /* Standard ID height */
      ...
      <div class="page-container">
        ...
        <div class="id-container">
          <div class="header-section">
            ...
            <div class="photo-box">
              ...
              if ($formalPic): 
                ...
                if (strpos($formalPic, 'data:image') === 0) {
                  $imgSrc = $formalPic;
                } else {
                  // barangayIDpictures is at root folder
                  $imgPath = realpath(__DIR__ . '/../barangayIDpictures/' . basename($formalPic));
                  
                  if ($imgPath && file_exists($imgPath)) {
                    $extension = strtolower(pathinfo($imgPath, PATHINFO_EXTENSION));
                    $mimeType = ($extension === 'png') ? 'png' : 'jpeg';
                    $imgSrc = 'data:image/' . $mimeType . ';base64,' . base64_encode(file_get_contents($imgPath));
                  } else {
                    $imgSrc = '';
                  }
                }
                ...
                if (!empty($imgSrc)): 
              ?>
                <img src="<?= $imgSrc ?>" style="width:100%; height:100%; object-fit:cover;" alt="Photo">
              <?php 
                endif;
              endif; 
              ?>
          ...
          <div class="id-number-box">
            <div class="id-number"><?= htmlspecialchars($data['barangay_id_number'] ?? '') ?></div>
          ...
          <div class="content-section">
            ...
            <div class="address-text">
              ...
              appears hereon is a registered member of this Barangay.<br>
              <br>This identification card is being issued for whatever lawful purpose it may serve.
            </div>
          </div>
        </div>
        ...
        <div class="id-back">
          ...
          <div class="back-content">
            <table style="width: 100%; margin-bottom: 2px; border-collapse: collapse;">
              <tr>
                <!-- Column 1: Thumb Box -->
                <td style="width: 75px; vertical-align: center; padding-right: 1px;">
                  <div class="thumb-box">
                ...
                <td style="width: 85px; vertical-align: top; padding-right: 1px;">
...
<head>
  <meta charset="UTF-8">
  <title>Barangay ID Preview</title>
  <style>
    @page { margin: 0; }
    body { 
      font-family: Arial, sans-serif; 
    ...
    .id-container {
      width: 3.375in; /* Standard ID width */
      height: 2.015in; /* Standard ID height */
      border: 3px solid #75b0fc;
      position: relative;
      background: white;
    }
