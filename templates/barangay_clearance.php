...
$remarks = $data['remarks'] ?? 'NO DEROGATORY RECORD';
...
if (!empty($picture)) {
    ...
    $possiblePaths = [
        realpath(__DIR__ . '/../barangayClearancePictures/' . basename($picture)),
        realpath(__DIR__ . '/../barangayClearancePictures/' . $picture),
...
if ($download || $print) {
    ...
    <body<?php if (!$includeHeader): ?> style="padding-top: 120px;"<?php endif; ?>>
      ...
      <div class="title-section">
        ...
        <p><strong>RECORD CLEARANCE</strong> from this office and the result(s) is/as listed below:</p>
      </div>
      ...
      <div class="main-content">
        <div class="left-section">
          ...
          <div class="info-row">
            ...
            <?= strtoupper(htmlspecialchars($street)) ?>
          </div>
          <div class="info-row">
          ...
          <div class="info-row">
            ...
            <?= strtoupper(date('F d, Y', strtotime($birthDate))) ?>
          </div>
          <div class="info-row">
          ...
          <div class="info-row">
            ...
            <?= strtoupper(htmlspecialchars($birthPlace)) ?>
          </div>
          <div class="info-row">
          ...
          <div class="info-row">
            ...
            <strong><?= strtoupper(htmlspecialchars($remarks)) ?></strong>
          </div>
          <div class="info-row">
      ...
      <div class="purpose-section">
        <?php if (!empty($purpose)): ?>
          THIS CERTIFICATION IS ISSUED FOR THE PURPOSE OF:<br>
          <div style="margin-left: 100px; margin-top: 10px;">
            <strong><?= strtoupper(htmlspecialchars($purpose)) ?></strong>
          </div>
        <?php else: ?>
          THIS CERTIFICATION IS ISSUED FOR: <br>
    ...
    $dompdf->render();
    $filename = 'barangay_clearance_' . $transactionId . '.pdf';
...
<head>
<meta charset="UTF-8">
<title>Barangay Clearance Preview</title>
  <style>
    body {
