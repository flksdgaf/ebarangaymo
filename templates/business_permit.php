...
<body>
  <div class="header">
    ...
    <div class="content">
      ...
      <div class="field"><span class="label">Barangay:</span> <span><?= htmlspecialchars($barangay) ?></span></div>
      ...
      <div class="field"><span class="label">Name of Business:</span> <span><?= htmlspecialchars($nameOfBusiness) ?></span></div>
      <div class="field"><span class="label">Type of Business:</span> <span><?= htmlspecialchars($typeOfBusiness) ?></span></div>
      <div class="field"><span class="label">Full Address:</span> <span><?= htmlspecialchars($fullAddress) ?></span></div>
