  ...
  <div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div class="dropdown">
      ...
      <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="requestFilterDropdown">
        ...
        <li><a class="dropdown-item" href="adminRequest.php?filter=Certifications">Certifications</a></li>
      </ul>
    </div>
  </div>
    ...
    <div class="table-responsive">
      <table class="table align-middle text-center">
        ...
        <tbody>
          ...
          $sql = "SELECT transaction_id, full_name, transaction_type, payment_method, payment_status, document_status FROM barangay_id_requests";
