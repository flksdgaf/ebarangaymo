      ...
      <div class="dropdown">
        ...
        <div class="dropdown-menu p-3" aria-labelledby="filterDropdown" style="min-width:260px; --bs-body-font-size:.75rem; font-size:.75rem;">
          <form method="get" id="filterForm" class="mb-0">
            <input type="hidden" name="page" value="adminSummon">
            <?php if (!empty($search)): ?>
            ...
            <div class="d-flex">
              <a href="?page=adminSummon" class="btn btn-sm btn-outline-secondary me-2">Reset</a>
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  addSummonBtn.addEventListener('click', () => {
    ...
    // Inject adminRedirect flag so the shared submit script knows
    let old = form.querySelector('input[name="adminRedirect"]');
    if (old) old.remove();
