...
$childRelationship = $data['child_relationship'] ?? '';
...
if ($download || $print) {
    ...
    <body<?php if (!$includeHeader): ?> style="padding-top: 150px;"<?php endif; ?>>
      ...
      <div class="content">
        ...
        <p>
          ...
          at Barangay Magang, Daet, Camarines Norte upon request of interested person for
    ...
    $dompdf->render();
    $filename = 'guardianship_' . $transactionId . '.pdf';
